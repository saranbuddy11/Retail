...
public class SendReport {
	...
	public void triggerMail(String path) {
		try {
			...
			email.setHtmlMsg(Constants.EMAIL_MESSAGE1+"<br><br>"+Constants.EMAIL_OVERALL_RESULT+"<br>"+result+"<br><br><br>"+Constants.EMAIL_MODULE_RESULT+"<br>"+moduleResult+"<br><br><br><br><br><br><br><br><br><br>"+Constants.EMAIL_MESSAGE2);
