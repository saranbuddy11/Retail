...
public class Promotions extends TestInfra {
	...
	public void verifyTenderDiscountWithTenderTypeCash() {
		try {
			...
			dropdown.selectItem(CreatePromotions.DPD_PROMO_TYPE, "Tender Discount", Constants.TEXT);
			...
			dropdown.selectItem(CreatePromotions.DPD_LOCATION, "All", Constants.TEXT);
			foundation.waitforElement(CreatePromotions.BTN_NEXT,2000);

			foundation.click(CreatePromotions.BTN_NEXT);
			dropdown.selectItem(CreatePromotions.MULTI_SELECT_TENDER_TYPES,"Cash", Constants.TEXT);
