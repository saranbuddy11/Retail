	...
	public void locationDropdownEditSystemOperator() {
		try {
			...
			List<String> locations = Arrays.asList(
					rstLockerSystemData.get(CNLockerSystem.LOCATION_NAME).split(Constants.DELIMITER_TILD));
			List<String> menuItems = Arrays.asList(
					rstNavigationMenuData.get(CNNavigationMenu.MENU_ITEM).split(Constants.DELIMITER_TILD));
			List<String> hasLocker = Arrays.asList(
					rstLocationSummaryData.get(CNLocationSummary.HAS_LOCKERS).split(Constants.DELIMITER_TILD));
