...
public class Consumer extends TestInfra {
	...
	public void BalanceIncrement() {
		try {
			...
			String Balance = (foundation.getText(ConsumerSearch.TXT_BALANCE));
			...
			foundation.waitforElement(ConsumerSearch.TXT_CONSUMER_NAME, 2000);
			foundation.click(ConsumerSearch.TXT_CONSUMER_NAME);
			...
			consumerSearch.enterSearchFields(rstConsumerSearchData.get(CNConsumerSearch.SEARCH_BY),
					...
					rstConsumerSearchData.get(CNConsumerSearch.LOCATION),
					rstConsumerSearchData.get(CNConsumerSearch.STATUS));
			String actualBalance = foundation.getText(ConsumerSearch.TXT_BALANCE);
			// validations
			...
			consumerSearch.enterSearchFields(rstConsumerSearchData.get(CNConsumerSearch.SEARCH_BY),
					...
					rstConsumerSearchData.get(CNConsumerSearch.LOCATION),
					rstConsumerSearchData.get(CNConsumerSearch.STATUS));
			String actualBalance2 = foundation.getText(ConsumerSearch.TXT_BALANCE);
			// validations
    ...
    public void cancelAdjustBalance() {
        try {
            ...
            foundation.click(consumerSearch.clickCell(requiredData.get(5)));
