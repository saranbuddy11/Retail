...
public class ConsumerSubsidy extends TestInfra {
	...
	public void verifySubsidyBalanceHistory() {
		...
		try {
			...
			Assert.assertTrue(foundation.isDisplayed(ConsumerSummary.LBL_BALANCE_HISTORY));
			Assert.assertTrue(foundation.isDisplayed(ConsumerSummary.BALANCE_HISTORY_GRID));
