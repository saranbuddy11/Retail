...
public class CreateAccount {
	...
	public static final By ADD_LATER=By.id("fgpinput-backbutton");
    ...
    public static final By ALL_SET=By.xpath("//h2[@data-reactid='.0.b.0.0.0.1.0.0.0']"); 
    ...
    public static final By BTN_EMAIL=By.xpath("//h2[@data-reactid='.0.b.0.0.0.1.0.0.3.1']");
