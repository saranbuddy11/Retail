...
public class V5TestPromotion extends TestInfra {
	...
	public void verifyOnScreenWithDiscountTimingAsRecurrenceForAllItem() {
		...
		try {
			...
			createPromotions.selectPromotionTimes(requiredData.get(4), Constants.DELIMITER_SPACE);
			createPromotions.recurringDay();
			createPromotions.selectOnScreenAllItem();
			String discountPrice = foundation.getAttributeValue(CreatePromotions.TXT_AMOUNT);
			foundation.click(CreatePromotions.BTN_NEXT);
			foundation.waitforElement(CreatePromotions.BTN_OK, Constants.SHORT_TIME);
			CustomisedAssert.assertEquals(foundation.getText(CreatePromotions.POPUP_HEADER), requiredData.get(8));
	 ...
	 * @date - 12/12/2022
	 */
	@Test(description = "220677 - Verify the Promotion is reflected in V5 device - Create/Expire Promotion for On Screen Promotion with Discount by All Item with Discount Type as Amount & Discount Timing as Scheduled")
	public void verifyOnScreenWithDiscountTimingAsScheduledForAllItem() {
		final String CASE_NUM = "220677";
	 ...
	 * @date - 14/12/2022
	 */
	@Test(description = "222207 - Verify the Promotion is reflected in V5 device - Create/Expire Promotion for On Screen Promotion with Discount by Single Category with Discount Type as Amount & Discount Timing as Recurrence")
	public void verifyOnScreenWithDiscountTimingAsRecurrenceForSingleCategory() {
		final String CASE_NUM = "222207";
		...
		try {
			...
			createPromotions.selectPromotionTimes(requiredData.get(4), Constants.DELIMITER_SPACE);
			createPromotions.recurringDay();
			createPromotions.selectOnScreenCategory(requiredData.get(3));
			String discountPrice = foundation.getAttributeValue(CreatePromotions.TXT_AMOUNT);
			foundation.click(CreatePromotions.BTN_NEXT);
			foundation.waitforElement(CreatePromotions.BTN_OK, Constants.SHORT_TIME);
			CustomisedAssert.assertEquals(foundation.getText(CreatePromotions.POPUP_HEADER), requiredData.get(8));
			...
			// login into Kiosk Device
			String price = landingPage.launchV5AndSelectProduct(requiredData.get(9));
	 ...
	 * @date - 15/12/2022
	 */
	@Test(description = "222236 - Verify the Promotion is reflected in V5 device - Create/Expire Promotion for On Screen Promotion with Discount by All Category with Discount Type as Amount & Discount Timing as Recurrence")
	public void verifyOnScreenWithDiscountTimingAsRecurrenceForAllCategory() {
		final String CASE_NUM = "222236";
		...
		try {
			...
			createPromotions.selectPromotionTimes(requiredData.get(4), Constants.DELIMITER_SPACE);
			createPromotions.recurringDay();
			createPromotions.selectOnScreenAllCategory();
			String discountPrice = foundation.getAttributeValue(CreatePromotions.TXT_AMOUNT);
			foundation.click(CreatePromotions.BTN_NEXT);
			foundation.waitforElement(CreatePromotions.BTN_OK, Constants.SHORT_TIME);
			CustomisedAssert.assertEquals(foundation.getText(CreatePromotions.POPUP_HEADER), requiredData.get(8));
	 ...
	 * @date - 16/12/2022
	 */
	@Test(description = "222249 - Verify the Promotion is reflected in V5 device - Create/Expire Promotion for On Screen Promotion with Discount by Single Category with Discount Type as Amount & Discount Timing as Scheduled")
	public void verifyOnScreenWithDiscountTimingAsScheduledForSingleCategory() {
		final String CASE_NUM = "222249";
	 ...
	 * @date - 19/01/2023
	 */
	@Test(description = "222282 - Verify the Promotion is reflected in V5 device - Create/Expire Promotion for On Screen Promotion with Discount by All Category with Discount Type as Amount & Discount Timing as Scheduled")
	public void verifyOnScreenWithDiscountTimingAsScheduledForAllCategory() {
		final String CASE_NUM = "222282";
