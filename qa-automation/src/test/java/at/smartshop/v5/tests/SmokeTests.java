...
public class SmokeTests extends TestInfra {
	...
	public void VerifyCreateEditExpireOnScreenPromotions() {
		...
		try {
			...
			foundation.click(CreatePromotions.BTN_NEXT);
			assertEquals(orgName, dropdown.getSelectedItem(CreatePromotions.DPD_DESELECT_ORGANIZATION));
			foundation.threadWait(Constants.TWO_SECOND);
	...
	public void VerifyCreateEditExpireTenderPromotions() {
		...
		try {
			...
			assertEquals(foundation.getText(CreatePromotions.LBL_BASICINFO), requiredData.get(1));
			assertEquals(foundation.getText(CreatePromotions.LBL_ENTER_BASICINFO), requiredData.get(2));
			...
			assertEquals(foundation.getText(CreatePromotions.LBL_DETAILS), requiredData.get(5));
			assertEquals(foundation.getText(CreatePromotions.LBL_SET_PROMO_DETAILS), requiredData.get(6));
	...
	public void VerifyCreateAddRemoveNewProduct() {
		...
		try {
			...
			Assert.assertTrue(foundation.getText(GlobalProduct.TXT_GLOBAL_PRODUCT).equals(requiredData.get(1)));
			foundation.click(GlobalProduct.BTN_CREATE);
			foundation.waitforElement(GlobalProduct.TXT_PRODUCT_CREATE, Constants.SHORT_TIME);
			Assert.assertTrue(foundation.getText(GlobalProduct.TXT_PRODUCT_CREATE).equals(requiredData.get(2)));
	...
	public void VerifyInventoryTab() {
		...
		try {
			...
			Assert.assertTrue(foundation.getText(LocationSummary.INVENTORY_NAME).equals(requiredData.get(1)));
			...
			foundation.threadWait(Constants.TWO_SECOND);
			textBox.enterText(LocationSummary.TXT_INVENTORY_FILTER, requiredData.get(1));
			Assert.assertTrue(foundation.getText(LocationSummary.INVENTORY_QUANTITY).equals(requiredData.get(3)));
	...
	public void addRemoveTaxes() {
		...
		try {
			...
			assertEquals(tax1, requiredData.get(4));
			assertEquals(tax2, requiredData.get(5));
			assertEquals(tax3, requiredData.get(6));
			assertEquals(tax4, requiredData.get(7));
