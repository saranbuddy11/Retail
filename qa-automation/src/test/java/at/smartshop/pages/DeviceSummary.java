...
public class DeviceSummary extends Factory {
	...
	public static final By TXT_NANOCREDIT = By
			.xpath("//select[@id='nanocreditrateusedevice']/option[@selected='selected']");
	public static final By CHECKBOX_SELF_SERVICES = By.id("cbx.services.SS");
    public static final By CHECKBOX_ORDER_AHEAD = By.id("cbx.services.OA");
    public static final By CHECKBOX_REMOTE = By.id("kioskRemote");
    public static final By TXT_CAFEAPIUPL = By.id("cafeapiurl");
	...
	public static final By DPD_OPTION_NANOCREDIT = By
			.xpath("//select[@id='nanocreditrateusedevice']/option[@value='1']");
	...
	/**
	 * verify check box in self service
	 */
	public void verifySelfService() {
		foundation.click(CHECKBOX_SELF_SERVICES);
		foundation.waitforElement(CHECKBOX_ORDER_AHEAD, Constants.SHORT_TIME);
		if (checkBox.isChecked(CHECKBOX_ORDER_AHEAD) == false) {
			foundation.click(CHECKBOX_ORDER_AHEAD);
		}
		foundation.waitforElement(CHECKBOX_REMOTE, Constants.SHORT_TIME);
		// validate Remote Button Displayed or not and cafeapiurl is present
		CustomisedAssert.assertTrue(foundation.isDisplayed(CHECKBOX_REMOTE));
		CustomisedAssert.assertTrue(foundation.isEnabled(TXT_CAFEAPIUPL));
		if (checkBox.isChecked(CHECKBOX_REMOTE) == false) {
			foundation.click(CHECKBOX_REMOTE);
		}
		CustomisedAssert.assertTrue(foundation.isDisabled(TXT_CAFEAPIUPL));
