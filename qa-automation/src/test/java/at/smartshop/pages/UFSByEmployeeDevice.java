...
public class UFSByEmployeeDevice extends Factory {
...
//	private static final By REPORT_GRID_FIRST_ROW_FOR_STAGING = By.cssSelector("#cashflow-SteveLocStaging-Non-Employee--VSH500024- > tbody > tr:nth-child(1)");
	...
	public void readAllRecordsFromCashFlowDetailsTable(String deviceId, String location) throws Exception {
		...
		String locationName = location.replace("@", Constants.DELIMITER_HYPHEN);
			String tableCashFlowDetails =  cashFlow + Constants.DELIMITER_HYPHEN + locationName + Constants.DELIMITER_HYPHEN + staffName
	...
	public void getTblRecordsUIOfSalesTimeDetails(String deviceId, String location) {
		try {
			int recordCount = 0;
//			String locationName = location.replace("@", Constants.DELIMITER_HYPHEN);
//			String tableCashFlowDetails = salesTime + Constants.DELIMITER_HYPHEN + locationName;
			...
			String locationName = location.replace("@", Constants.DELIMITER_HYPHEN);
			String tableCashFlowDetails =  salesTime + Constants.DELIMITER_HYPHEN + locationName + Constants.DELIMITER_HYPHEN + staffName
					+ Constants.DELIMITER_HYPHEN + Constants.DELIMITER_HYPHEN + deviceId.toUpperCase()
					+ Constants.DELIMITER_HYPHEN;
