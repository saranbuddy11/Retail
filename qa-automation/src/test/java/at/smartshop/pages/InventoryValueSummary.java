...
public class InventoryValueSummary extends Factory {
	...
	public Map<Integer, Map<String, String>> getTblRecordsUI() {
		try {
			int recordCount = 0;
			tableHeaders.clear();
			WebElement tableReportsList = getDriver().findElement(TBL_INVENTORY_VALUE_SUMMARY_GRID);
			WebElement tableReports = getDriver().findElement(TBL_INVENTORY_VALUE_SUMMARY);
