...
public class LockerSystem extends Factory {
	...
	public void disableLocker(String address) {
		foundation.click(By.xpath("//td[@aria-describedby='cubbyschedulinggrid_address'][text()='" + address
				+ "']//..//td[@aria-describedby='cubbyschedulinggrid_disable']//a"));
	...
	public By objresetleLocker(String address) {
		return By.xpath("//td[@aria-describedby='cubbyschedulinggrid_address'][text()='" + address
				+ "']//..//td[@aria-describedby='cubbyschedulinggrid_reset']//a");
	}

	public String cubbyStatus(String address) {
		return foundation.getText(By.xpath("//td[@aria-describedby='cubbyschedulinggrid_address'][text()='" + address
				+ "']//..//td[@aria-describedby='cubbyschedulinggrid_status']"));
	}
