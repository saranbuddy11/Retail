...
public class VoidedProductReport extends Factory {
	...
	public void processAPI(String value, String flag, String environment) {
		try {
			generateJsonDetails(value, environment);
			salesJsonDataUpdate(flag, environment);
	...
	private void salesJsonDataUpdate(String voidedFlag, String environment) {
		try {
