...
public class HealthAheadReport extends Factory {
	...
	public void processAPI(String redeemed, String coupon, String environment) {
		try {
			generateJsonDetails(environment);
			salesJsonDataUpdate(redeemed, coupon, environment);
	...
	private void salesJsonDataUpdate(String redeemed, String coupon, String environment) {
		try {
