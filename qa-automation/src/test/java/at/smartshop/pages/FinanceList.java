...
public class FinanceList {
	...
	public static final By VALIDATE_DATE =  By.xpath("//td[text()='Wednesday - 09/29/2021']");
	...
	public static final By DOWNLOAD_DISBURSEMENT_REPORT =  By.xpath("//a[@onclick='downloadExcel(\"Wednesday - 09/29/2021\")']");
	public static final By VIEW_VARIANCE =  By.xpath("//a[@onclick='viewVarianceData(\"Wednesday - 09/29/2021\")']");
	public static final By DOWNLOAD_CSV_REPORT =  By.xpath("//a[@onclick='downloadCsv(\"Wednesday - 09/29/2021\")']");
