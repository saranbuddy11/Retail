...
public class FinanceList {
	...
	public static final By VALIDATE_DATE =  By.xpath("//td[text()='Friday - 01/29/2021']");
	...
	public static final By DOWNLOAD_DISBURSEMENT_REPORT =  By.xpath("//a[@onclick='downloadExcel(\"Friday - 01/29/2021\")']");
	public static final By VIEW_VARIANCE =  By.xpath("//a[@onclick='viewVarianceData(\"Friday - 01/29/2021\")']");
	public static final By DOWNLOAD_CSV_REPORT =  By.xpath("//a[@onclick='downloadCsv(\"Friday - 01/29/2021\")']");
