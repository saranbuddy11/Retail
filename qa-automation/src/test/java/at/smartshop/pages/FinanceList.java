...
public class FinanceList {
	...
	public static final By VALIDATE_DATE =  By.xpath("//td[text()='Tuesday - 09/29/2020']");
	...
	public static final By DOWNLOAD_DISBURSEMENT_REPORT =  By.xpath("//a[@onclick='downloadExcel(\"Tuesday - 09/29/2020\")']");
	public static final By VIEW_VARIANCE =  By.xpath("//a[@onclick='viewVarianceData(\"Tuesday - 09/29/2020\")']");
	public static final By DOWNLOAD_CSV_REPORT =  By.xpath("//a[@onclick='downloadCsv(\"Tuesday - 09/29/2020\")']");
