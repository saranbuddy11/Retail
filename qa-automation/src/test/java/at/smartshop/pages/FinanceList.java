...
public class FinanceList {
	...
	public static final By VALIDATE_DATE =  By.xpath("//td[text()='Thursday - 03/18/2021']");
	...
	public static final By DOWNLOAD_DISBURSEMENT_REPORT =  By.xpath("//a[@onclick='downloadExcel(\"Thursday - 03/18/2021\")']");
	public static final By VIEW_VARIANCE =  By.xpath("//a[@onclick='viewVarianceData(\"Thursday - 03/18/2021\")']");
	public static final By DOWNLOAD_CSV_REPORT =  By.xpath("//a[@onclick='downloadCsv(\"Thursday - 03/18/2021\")']");
