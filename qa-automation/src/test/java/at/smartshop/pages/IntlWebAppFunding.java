...
public class IntlWebAppFunding extends Factory {
	...
	public void getTblRecordsUI() {
		try {
			int recordCount = 0;
			tableHeaders.clear();
			WebElement tableReportsList = getDriver().findElement(TBL_INTL_WEB_APP_FUNDING_GRID);
			WebElement tableReports = getDriver().findElement(TBL_INTL_WEB_APP_FUNDING);
