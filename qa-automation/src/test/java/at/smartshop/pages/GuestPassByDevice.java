...
public class GuestPassByDevice extends Factory {
	...
	private static final By TBL_GUEST_PASS_BY_DEVICE = By.id("rptdt");
	private static final By TBL_GUEST_PASS_BY_DEVICE_GRID = By.cssSelector("#rptdt > tbody");
	...
	public void getTblRecordsUI() {
		try {
			int recordCount = 0;
			tableHeaders.clear();
			WebElement tableReportsList = getDriver().findElement(TBL_GUEST_PASS_BY_DEVICE_GRID);
			WebElement tableReports = getDriver().findElement(TBL_GUEST_PASS_BY_DEVICE);
