...
public class TipDetailsReport extends Factory {
	...
	public void getRequiredRecord(String consumerName, String transID) {
	...
	public void updateData(String values, String tip) {
		try {
	...
	public void processAPI(String value, String tip, String environment) {
		try {
			generateJsonDetails(value, environment);
			salesJsonDataUpdate(tip, environment);
...
//	}
	...
	private void salesJsonDataUpdate(String tip, String environment) {
		try {
