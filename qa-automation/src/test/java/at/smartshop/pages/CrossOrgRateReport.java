...
public class CrossOrgRateReport extends Factory {
	...
	private static final By TBL_CROSS_ORG_RATE = By.id("rptdt");
	private static final By TBL_CROSS_ORG_RATE_GRID = By.cssSelector("#rptdt > tbody");
	...
	/**
	 * This method is to read the data from the Report Table
	 * @return
	 */
	public Map<Integer, Map<String, String>> getTblRecordsUI() {
		try {
			int recordCount = 0;
			tableHeaders.clear();
			WebElement tableReportsList = getDriver().findElement(TBL_CROSS_ORG_RATE_GRID);
			WebElement tableReports = getDriver().findElement(TBL_CROSS_ORG_RATE);
